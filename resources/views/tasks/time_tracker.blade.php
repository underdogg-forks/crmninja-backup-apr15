    ...
    <div class="container-fluid">
      <div class="navbar-collapse" style="padding-top:12px; padding-bottom:12px;">
        ...
        <div class="input-group input-group-lg">
          ...
          <span class="input-group-addon" style="width:1%;" data-bind="click: onRefreshClick, visible: ! filter()"
                title="{{ trans('texts.refresh') }}">
            ...
            <form id="taskForm">
                ...
                <div style="padding-bottom: 20px">
                       ...
                       style="margin-bottom: 0px !important;">
                           ...
                           class="fa fa-minus-circle redlink" title="{{ trans('texts.remove') }}"/>
											</td>
