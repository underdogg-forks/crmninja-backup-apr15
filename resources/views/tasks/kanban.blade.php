...
@section('content')
  ...
  <div class="kanban" style="display: none">
    <div
      data-bind="sortable: { data: statuses, as: 'status', afterMove: onStatusDragged, allowDrop: true, connectClass: 'connect-column' }"
      style="float:left">
      <div class="well kanban-column">
        ...
        <div
          data-bind="sortable: { data: tasks, as: 'task', afterMove: onTaskDragged, allowDrop: true, connectClass: 'connect-row' }"
          ...
          <div class="kanban-column-row"
            ...
            <div class="view" data-bind="event: { click: startEditTask }">
              <div class="panel"
                ...
                <div
                  data-bind="text: description().length > 100 ? description().substring(0, 100) + '...' : description()"></div>
              </div>
            </div>
            <div class="edit">
              <textarea
