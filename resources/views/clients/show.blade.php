    ...
    <div class="panel-body">
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          @if ($client->id_number)
            <p><i class="fa fa-id-number" style="width: 20px"></i>{{ trans('texts.id_number').': '.$client->id_number }}
            </p>
          @endif
          ...
          <h3>{{ trans('texts.standing') }}
            <table class="table" style="width:100%">
              <tr>
                ...
                <td
                  style="text-align: right">{{ Utils::formatMoney($client->paid_to_date, $client->getCurrencyId()) }}</td>
              </tr>
              <tr>
                <td>
